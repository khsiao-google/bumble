...
async def test_enter_and_exit_sniff_mode():
    ...
    m.assert_called_with(hci.HCI_SUCCESS, hci.HCI_Mode_Change_Event.Mode.SNIFF, 2)
    ...
    m.assert_called_with(hci.HCI_SUCCESS, hci.HCI_Mode_Change_Event.Mode.ACTIVE, 2)
